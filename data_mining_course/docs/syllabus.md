...
6.  **時間序列與大模型非結構化資料前處理**: 時間序列特徵工程，以及用 2026 主流技術棧
    （PyTorch + HuggingFace）處理文字、圖像、聲音、影片，產出大模型可訓練的張量與資料集格式。 (✅ 完成)
7.  **資料探勘應用與總結**: 介紹關聯規則、聚類分析等演算法，並回顧端到端的專案流程。 (✅ 完成)
8.  **下游模型訓練**: 前處理之後能訓練什麼模型——分類微調、LLM 的 LoRA/SFT、RAG，
    以及生成式與多模態大模型的訓練藍圖。 (✅ 完成)