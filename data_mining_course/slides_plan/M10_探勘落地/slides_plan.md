...
|---|---|---|---|---|---|
| 1 | 道 | 問題定位 | 這堂把前面所有工具接成一條線，重點不是演算法步驟，是重要性要對得回理由 | `03_tree_models/01_xgboost_features.ipynb` | 圖 1 |
...
| 8 | 器 | 工具速查 | `XGBoost`、`LightGBM` 的重要性取用、`KMeans`、`DBSCAN` 的最小範例 | `01_association_rules/01_apriori_algorithm.ipynb` | |
